function circularHeatChart() {
    ...
    function chart(selection) {
        selection.each(function(data) {
            var svgWidth = document.getElementById("calendarBody").offsetWidth;
